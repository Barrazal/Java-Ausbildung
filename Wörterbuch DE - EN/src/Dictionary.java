...
public class Dictionary {
    ...
    public static void onStart(HashMap<String,String> h1){
    ...
    private static void loop(int addDelNumb,HashMap<String,String> h1) {
        Scanner scan1 = new Scanner(System.in);
        ...
        if (addDelNumb == 0) {
            ...
            String[] translate = scan1.next().split(",");
            removeTranslation(translate, h1);
            onStart(h1);
    ...
    private static HashMap<String, String> addTranslation(String[] translate, HashMap h1) {
        h1.put(translate[0], translate[1]);
        return h1;
    }

    private static HashMap<String, String> removeTranslation(String[] translate, HashMap h1) {
