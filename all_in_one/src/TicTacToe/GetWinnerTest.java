...
public class GetWinnerTest {
 ...
 //               1, 1, 2
 //       };
 //       assertEquals(3, TicTacToe.CheckGameStatus(ticTacToeField));
 //   }
//
 //   @Test
 ...
 //               2, 0, 2
 //       };
 //       assertEquals(1, TicTacToe.CheckGameStatus(ticTacToeField));
 //   }
//
 //   @Test
 ...
 //               0, 1, 2
 //       };
 //       assertEquals(2, TicTacToe.CheckGameStatus(ticTacToeField));
 //   }
//
 //   @Test
